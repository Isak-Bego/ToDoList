...
export function ProjectManager() {
  ...
  this.initialize = () => {
    ...
    if (Object.keys(localStorage).length == 0) {
      ...
      t.order = 1;
      this.projects.push(t);
      saveToLS(this.projects[0].title, [
        this.projects[0].order,
        this.projects[0].toDoList,
      ]);
      saveToLS(this.projects[1].title, [
        this.projects[1].order,
        this.projects[1].toDoList,
      ]);
    } else {
